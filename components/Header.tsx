...
export default function Header() {
  return (
    <header className="fixed top-0 left-0 right-0 z-50 backdrop-blur-2xl bg-bg/50 border-b border-white/5">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-3 md:py-4 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-4 lg:gap-8">
          <a href="#stack" className="relative text-gray-400 hover:text-white transition-colors text-sm font-medium group">
            <span className="relative z-10">Stack</span>
            <span className="absolute inset-0 bg-yellow-primary/10 scale-0 group-hover:scale-100 rounded-lg transition-transform duration-300" />
          </a>
